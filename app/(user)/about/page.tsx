          ...
          <BodyWrapper>
            ...
            {/* Our philosophy section  */}
              <div className="grid grid-cols-1 md:grid-cols-3 place-content-center place-items-center px-10 pt-10">
                ...
                <div className="place-self-start">
                  <div>
                    <div>
                      ...
                      <p className="font-bold text-1xl">Flavourful Journey For Healthy <br /> Living</p>
                    </div>
                  </div>
                  <div className="pt-[18rem]">
                    <div>
                      <Subtitle icon={arrowIcon} title="Our Commitment" />
                      <p className="font-bold text-1xl">Quality, Flavour, and Purity</p>
                    </div>
                  </div>
                  <div className="pt-[18rem]">
                    <div>
                ...
                <div className="place-self-start">
                  <p className="pt-5">
                    As someone who has navigated the transformative path of
                    health and wellness through mindful eating and a balanced
                    diet, I understand the pivotal role of herbs and spices not
                    just in flavoring our meals, but in enriching our health. At
                    Claire&apos;s Delight, we don&apos;t just offer spices; we
                    offer keys to a healthier lifestyle. Whether it&apos;s
                    through our carefully crafted blends that bring out the best
                    in every meal or our specially formulated teas that soothe
                    and rejuvenate, we&apos;re here to guide you on a journey of
                  ...
                  <p className="mt-[3rem]">
                    ...
                    commitment to excellence. Each herb and spice is selected
                    with the utmost care, ensuring they are not only rich in
                    flavor but also adhere to the highest standards of hygiene
                    and quality. Our selection process is rigorous, and we pride
                    ourselves on providing products that are not only vibrant
                    and flavorful but also free from chemicals & additives. With
                    Claire&apos;s Delight, you&apos;re not just enhancing your
                    meals; you&apos;re choosing a healthier, more vibrant
                    lifestyle.
                  </p>
                  <p className="mt-[2rem]">
