  ...
  return (
    <div>
      ...
      <div className="flex justify-evenly flex-col-reverse md:flex-row items-center mx-10 xl:mx-16 mt-7 gap-8 md:gap-0">
        <p className=" md:w-[304px] lg:w-[700px] text-[13px] md:text-[12px] lg:text-[13px] xl:text-[15px] leading-[14px] lg:leading-[24px]  text-center md:text-start  ">
      ...
      <div className="flex flex-col  items-center mt-[6rem]">
        <div className="flex justify-center px-10 items-start gap-10">
